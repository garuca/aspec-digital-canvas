            ...
            <nav className="hidden lg:flex items-center gap-1">
              {getNavItems().map((item) => (
                <a
                  ...
                  className={`relative px-5 py-2.5 font-exo text-sm font-medium transition-all duration-300 rounded-lg ${activeItem === item.key
                      ? "text-white"
                ...
                >
                  ...
                  <span className={`absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 transition-all duration-300 ${activeItem === item.key ? "w-1/2" : "group-hover:w-1/2"
                    }`} />
                </a>
              ))}
            </nav>
                ...
                <nav className="flex flex-col gap-2">
                  {getNavItems().map((item) => (
                    <a
                      ...
                      className={`px-4 py-3 font-exo text-base font-medium rounded-xl transition-all duration-300 ${activeItem === item.key
